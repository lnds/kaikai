...
| Fixture(s) | Issue |
| --- | --- |
| ~~`pattern_duplicate_binding.kai`, `pattern_duplicate_variant_arm.kai`, `pattern_duplicate_literal_arm.kai`, `unbound_tyvar_in_signature.kai`~~ | [#534](https://github.com/lnds/kaikai/issues/534) — pattern checker + unbound tyvar gaps (closed: shapes 1-3 in `examples/negative/patterns/`; shape 4 in `examples/negative/type_invariants/`) |
