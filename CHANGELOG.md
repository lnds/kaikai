...
- **kir**: lower a match over a tuple of lists on the native backend

## v0.109.0 (2026-08-07)

### Added

- **stdlib**: add non-ASCII case folding for Greek, Cyrillic and Latin-1
...
- **runtime**: route the C-backend scheduler through the -O0 owner object under clang (closes #1238) (#1240)

## v0.99.19 (2026-07-15)

### Fixed

- **runtime**: compile the M:N scheduler outside the clang-hoisted hot bitcode (closes #1234)
